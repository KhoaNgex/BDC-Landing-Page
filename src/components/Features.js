    ...
    <section className="my-[70px]">
      <div className="container mx-auto">
        ...
        <div className="text-center">
          ...
          <p
            className="lead max-w-[750px] mx-auto mb-16 xl:mb-24"
            data-aos="fade-down"
            data-aos-delay="200"
          >
            {subtitle}
        ...
        <div className="grid grid-cols-1 gap-[50px] xl:grid-cols-2">
          {list.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="mb-12 w-full max-w-[550px] h-[358px] relative flex flex-col items-center justify-center xl:flex-row xl:justify-start mx-auto"
                data-aos="zoom-in"
                data-aos-offset="100"
              ...
              >
                ...
                {/* icon image */}
                <div
                  className="max-w-[180px] xl:max-w-[275px]"
